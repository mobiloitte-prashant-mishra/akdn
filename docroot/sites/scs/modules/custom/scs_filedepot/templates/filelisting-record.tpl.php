        ...
        <div class="floatright">
          <?php if(isset($action1_link)) { ?>
            <div class="floatright <?php print $actionclass?>">
                ...
                <span style="padding-right:10px"><?php print $action3_link ?></span>
                <span style="padding-right:10px"><?php print $action5_link ?></span>
                <span><?php print $action4_link ?></span>
                <span style="display:<?php print $show_approvalsubmitter ?>;"><?php print $submitter ?></span>
            </div>
            <?php } ?>
            <div class="floatright" style="padding-right:15px"><?php print $modified_date ?></div>
            <div class="floatright" style="padding-right:20px;display:<?php print $show_submitter ?>;"><?php print $submitter ?></div>
