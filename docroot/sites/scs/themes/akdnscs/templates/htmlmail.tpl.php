...
<div class="htmlmail-body">
  <div style="width:600px;font:normal 85%/120% Arial,Helvetica,sans-serif;border-left:1px solid rgb(238,238,238);border-right:1px solid rgb(238,238,238);color:#000">
	  <div style="text-align:center;border-top:30px solid #f2edde;padding-top:10px;padding-bottom:5px;font-size:20px">
	    <?php print $site_name; ?>
	  </div>
	  <div style="text-align:center;padding-top:10px;padding-bottom:5px;font-size:20px">
	    <?php print $site_slogan; ?>
	  </div>
	  <div style="font-size:12px;padding:10px">
	  	<?php echo $body; ?>
	  </div>
	  <div style="text-align:center;border-top:30px solid #f2edde;margin-top:10px;clear:both;margin-bottom:3%">
	  </div>
  </div>
</div>
