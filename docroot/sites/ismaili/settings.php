...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/akdn/ismaili-settings.inc';
  //Enable new temporary file path.
  $conf['file_temporary_path'] = "/mnt/tmp/akdndev";
  // Enable memcache.
...
if (extension_loaded('newrelic')) {
    $arr = explode('/', conf_path());
    $site_domain = array_pop($arr);
