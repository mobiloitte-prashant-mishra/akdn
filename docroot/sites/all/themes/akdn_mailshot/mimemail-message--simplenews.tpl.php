    ...
    <div id="center">
      <div id="main" style="color: black; line-height:16px;">
          <div class="logo" style="text-align: center; border-top: 30px solid #b49759; padding-top: 10px; padding-bottom: 8px;">
            <a href = 'http://www.akdn.org' style="display: block; margin: auto;"><img <?php print 'src= http://srijanaravali.github.io/akdn/images/akdn-logo.png' ?> alt="<?php print t('Home'); ?>" style="width: 120px; height: 55px; margin:10px auto" /></a>
          </div>
          ...
          <div class="header">
            ...
            <div class="last">
             <i>Do you have friends and family members who would like to receive this newsletter? Invite them to sign up at</i> <a href="subscribe">http://www.akdn.org.</a>
            </div>
          </div>
      </div>
    </div>
