...
<?php if (!$opt_out_hidden): ?>
  <?php if ($format == 'html'): ?>
    <p class="newsletter-footer"><i>This email was sent to you at</i> [simplenews-subscriber:mail] <i>because you are subscribed to receive this email newsletter. If you no longer want to receive these emails or if you would like to update your settings, </i><a href="[simplenews-subscriber:unsubscribe-url]">please click here.</a></p>
  <?php else: ?>
