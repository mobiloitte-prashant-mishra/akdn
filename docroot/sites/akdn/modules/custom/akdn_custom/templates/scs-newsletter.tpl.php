...
<?php
  ...
  if (!empty($title)) {
    $output .= '<h2 style="color:#b49759;font-weight:bold;font-size:12px;font-family:Arial,Serif;line-height:16px;margin:0 0 5px;text-transform:capitalize;">' . l($title, 'node/' . $node['#node']->nid) . '</h2>';
  }
  if (!empty($body)) {
